...
export default class Pelletizing extends Component {
    constructor(props) {
        super(props);
        this.state = {
            keys: "1",
    ...
    render() {
        return (
            <Tabs onChange={this.callback.bind(this)} type="card">
                {
                    window.location.search ? <TabPane tab="球团" key="1" forceRender={false}>
                        <PelletizingOne
                        ...
                        />
                    </TabPane> : <TabPane tab="球团一系列" key="1" forceRender={false}>
                        <PelletizingOne
                            keys={this.state.keys}
                            gaoluThree={this.state.gaoluThree}
                            gaoluTwo={this.state.gaoluTwo}
                ...
                }
                {
                    window.location.search ? null :
                        <TabPane tab="球团二系列" key="2" forceRender={false}>
                            <PelletizingOne
                                keys={this.state.keys}
                                gaoluThree={this.state.gaoluThree}
                                gaoluTwo={this.state.gaoluTwo}
