...
//到导入烧结矿粉
class BudgetFen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            list: [],
                ...
                <Form onSubmit={this.handleSubmit} className="login-form" >
                    ...
                    <Form.Item style={{ width: 200 }}>
                        {getFieldDecorator('number')(
                            ...
                            >
                                {
                                   (this.state.valueName==="熔剂" ? this.state.RjList :this.state.list).map((items, index) => {
                                        return (
...
const WrappedBudgetFen = Form.create({ name: 'BudgetFen' })(BudgetFen);
