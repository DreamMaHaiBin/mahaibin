...
for(let i=0;i<11;i++){
 ...
 export default class  PenChuiMei  extends Component{
     ...
     componentDidMount(){
        axios.get(`/api/estimate-ore/recent/?purpose=${this.props.tabKeys==="2"? 163:this.props.tabKeys==="3"?183:13}`,{
            headers:{
    ...
    pen(){
        ...
        axios.post("/api/estimate-mean/",{
            purpose: this.props.tabKeys==="2"? 163:this.props.tabKeys==="3"?183:13,
            ore:
