...
export default class DateClearDateSettlementFurnace extends Component {
    ...
    initData() {
        axios({
            ...
            if (res.status === 200 && res.data && res.data.dos) {
                ...
                this.setState({
                    ListData: this.saveTwoNumber(gaoluListData)
                })
            }
        }).catch(error => {
            console.log(error)
    ...
    arrItemNumber(Array) {
        Array.forEach(obj => {
            ...
            obj.yglrdh = String(obj.yglrdh) === "NaN" || String(obj.yglrdh) === "null" ? 0 : Number(obj.yglrdh)
            obj.yglydh = String(obj.yglydh) === "NaN" || String(obj.yglydh) === "null" ? 0 : Number(obj.yglydh)
            obj.yglrcb = String(obj.yglrcb) === "NaN" || String(obj.yglrcb) === "null" ? 0 : Number(obj.yglrcb)
            obj.yglycb = String(obj.yglycb) === "NaN" || String(obj.yglycb) === "null" ? 0 : Number(obj.yglycb)

            obj.eglrdh = String(obj.eglrdh) === "NaN" || String(obj.eglrdh) === "null" ? 0 : Number(obj.eglrdh)
            obj.eglydh = String(obj.eglydh) === "NaN" || String(obj.eglydh) === "null" ? 0 : Number(obj.eglydh)
            obj.eglrcb = String(obj.eglrcb) === "NaN" || String(obj.eglrcb) === "null" ? 0 : Number(obj.eglrcb)
            obj.eglycb = String(obj.eglycb) === "NaN" || String(obj.eglycb) === "null" ? 0 : Number(obj.eglycb)

            obj.sglrdh = String(obj.sglrdh) === "NaN" || String(obj.sglrdh) === "null" ? 0 : Number(obj.sglrdh)
            obj.sglydh = String(obj.sglydh) === "NaN" || String(obj.sglydh) === "null" ? 0 : Number(obj.sglydh)
            obj.sglrcb = String(obj.sglrcb) === "NaN" || String(obj.sglrcb) === "null" ? 0 : Number(obj.sglrcb)
            obj.sglycb = String(obj.sglycb) === "NaN" || String(obj.sglycb) === "null" ? 0 : Number(obj.sglycb)
        })
        return Array
    }
    saveTwoNumber(Array) {
                                ...
                                this.state.ListData.map((item, index) => {
                                    return (
                                        <tr key={index} className={
                                            ...
                                            <td>
                                                <Input onKeyUp={this.mustNumber.bind(this)}
                                                    value={item.yglrdh === strFour || item.yglrdh === 0 ? null : item.yglrdh}
                                            ...
                                            <td>
                                                <Input onKeyUp={this.mustNumber.bind(this)}
                                                    value={item.yglydh === strFour || item.yglydh === 0 ? null : item.yglydh}
                                            ...
                                            <td>
                                                <Input onKeyUp={this.mustNumber.bind(this)}
                                                    value={item.eglrdh === strFour || item.eglrdh === 0 ? null : item.eglrdh}
                                            ...
                                            <td>
                                                <Input onKeyUp={this.mustNumber.bind(this)}
                                                    value={item.eglydh === strFour || item.eglydh === 0 ? null : item.eglydh}
                                            ...
                                            <td>
                                                <Input onKeyUp={this.mustNumber.bind(this)}
                                                    value={item.sglrdh === strFour || item.sglrdh === 0 ? null : item.sglrdh}
                                            ...
                                            <td>
                                                <Input onKeyUp={this.mustNumber.bind(this)}
                                                    value={item.sglydh === strFour || item.sglydh === 0 ? null : item.sglydh}
