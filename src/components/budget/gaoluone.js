    ...
    computedInfo() {
        axios.post("/api/estimate-gl/", {
            ...
            para: {
                ...
                cmd: this.state.luzha.cmd==="" || this.state.luzha.cmd===null ? "0" :this.state.luzha.felron,    // 高炉可变加工费
                fcms: this.state.luzha.fcms==="" || this.state.luzha.felron===null ? "0" :this.state.luzha.felron,  // 高炉固定加工费
